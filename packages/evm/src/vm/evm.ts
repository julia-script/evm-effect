...
import { type Address, Bytes, U256 } from "@evm-effect/ethereum-types";
...
export class Evm extends Context.Service<Evm>()("Evm", {
  make: (partial: {
    message: Message;
    ...
    Effect.gen(function* () {
      ...
      return {
        ...
        accountsToDelete: HashSet.empty<Address>(),
        touchedAccounts: HashSet.empty<Address>(),
...
// export class Evm extends Context.Service<
//   Evm,
//   {
//     pc: Ref.Ref<number>;
//     stack: Stack;
