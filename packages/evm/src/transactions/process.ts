...
export const getLast256BlockHashes = Effect.fn("getLast256BlockHashes")(
  function* (chain: BlockChain) {
    ...
    const mostRecentBlockHash = keccak256(
      yield* recentBlocks[recentBlocks.length - 1].header.encode(),
    );
